...
const subscribe_handler = reqlfn =>
  (raw_request, context, ruleset, metadata, send, done) => {
    let feed;
    const reql = reqlfn(raw_request, metadata);
...
const run = subscribe_handler(make_reql);

module.exports = { run, subscribe_handler };
